                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <strong class="col-md-12" style="margin-top: 5rem;">Selamat datang admin UPT Computer</strong>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright ©2021 | Desain by SMKN 1 MEJAYAN</p>
                                </div>
                            </div>
                        </div>
                    </div>
